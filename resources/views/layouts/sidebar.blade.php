...
<div class="main-body">
    <div class="nav-bar">
        ...
        <div class="nav-item-list">
            ...
            <div class="nav-item">
                <div class="item-text"><a class="nav-link" href="{{ route('schedules.index') }}">Agenda</a></div>
            </div><br>
            <div class="nav-item">
                <div class="item-text"><a class="nav-link" href="{{ route('profiles.edit', Auth::id()) }}">Editar Perfil</a></div>
            </div><br>
        </div>
    </div>
</div>
